...
model = xgb.Booster()
model.load_model('C:/Users/Aman/Desktop/XgBoost/Backend/myenv/waterfootprint_xgboost_model.json')
...
@app.post("/save")
def save(input_data: InputData, water_footprint: float):
    ...
    try:
        ...
        df.to_csv('C:/Users/Aman/Desktop/XgBoost/Backend/water_footprint.csv', mode='a', header=False, index=False)
    except Exception as e:
        print(f"Error saving data to CSV: {e}")  # Log the error
